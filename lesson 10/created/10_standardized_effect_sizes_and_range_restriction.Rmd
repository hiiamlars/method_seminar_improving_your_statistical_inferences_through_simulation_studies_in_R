...
mean_no_preselection <- subset_no_preselection |>
  group_by(condition) |>
...
mean_preseleciton <- subset_preselection_for_severe |>
  group_by(condition) |>
  summarize(mean_bdi_score = mean(bdi_score)) |>
  pivot_wider(names_from = condition,
              values_from = mean_bdi_score) |>
...
# result
mean_no_preselection$mean_diff - mean_preseleciton$mean_diff

# standardized mean difference
mean_std_no_preselection <- effsize::cohen.d(formula = bdi_score ~ condition,
                 data = subset_no_preselection)$estimate |>
  round_half_up(2)

mean_std_preseleciton <- effsize::cohen.d(formula = bdi_score ~ condition,
                 data = subset_preselection_for_severe)$estimate |>
  round_half_up(2)

# result
mean_std_preseleciton - mean_std_no_preselection
